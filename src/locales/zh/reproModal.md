...
除非你的 bug 只有在构建工具下才能重现，否则我们建议使用 <a href="https://codesandbox.io/s/" target="_blank">CodeSandbox for go-admin</a> 来提供重现。如果你的 bug 必须用到构建工具，那么我们建议使用 <a href="https://doc.go-admin.dev" target="_blank">create-go-admin-app</a> 来搭建一个新项目，推送到 GitHub 并提供仓库的链接。
